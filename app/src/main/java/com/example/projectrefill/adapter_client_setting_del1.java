...
public class adapter_client_setting_del1 extends FirebaseRecyclerAdapter<client_model_setting_accp1,adapter_client_setting_del1.myviewholder> {

    public adapter_client_setting_del1(@NonNull FirebaseRecyclerOptions<client_model_setting_accp1> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull client_model_setting_accp1 model) {
        ...
        holder.rname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                appCompatActivity.getSupportFragmentManager().beginTransaction().replace(R.id.frmlayoutclientdel1,new settings_client_delivere2_Fragment(model.getRname())).addToBackStack("client_deli").commit();
