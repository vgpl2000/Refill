...
public class settings_client_accp1_Fragment extends Fragment {
    ...
    public static settings_client_accp1_Fragment newInstance(String param1, String param2) {
        settings_client_accp1_Fragment fragment = new settings_client_accp1_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View v= inflater.inflate(R.layout.fragment_settings_client_accp1_, container, false);
        ...
        FirebaseRecyclerOptions<client_model_setting_accp1> options =
                new FirebaseRecyclerOptions.Builder<client_model_setting_accp1>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Client").child("c_accepted"),client_model_setting_accp1.class)
                        .build();
