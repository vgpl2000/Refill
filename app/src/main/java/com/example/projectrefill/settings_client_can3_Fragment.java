...
public class settings_client_can3_Fragment extends Fragment {
    ...
    public settings_client_can3_Fragment() {
        // Required empty public constructor
    }

    public settings_client_can3_Fragment(String date, String name) {
        this.date = date;
        this.name = name;
    }

    public static settings_client_can3_Fragment newInstance(String param1, String param2) {
        settings_client_can3_Fragment fragment = new settings_client_can3_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View v= inflater.inflate(R.layout.fragment_settings_client_can3_, container, false);
        ...
        FirebaseRecyclerOptions<client_model_setting_accp3> options =
                new FirebaseRecyclerOptions.Builder<client_model_setting_accp3>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Client").child("c_cancelled").child(name).child("date").child(date).child("Items"),client_model_setting_accp3.class)
                        .build();
