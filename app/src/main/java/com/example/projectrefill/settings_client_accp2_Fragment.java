...
public class settings_client_accp2_Fragment extends Fragment {
    ...
    adapter_client_setting_accp2 adapter;

    public settings_client_accp2_Fragment() {
        // Required empty public constructor
    }

    public settings_client_accp2_Fragment(String rname) {
        this.rname = rname;
    }

    public static settings_client_accp2_Fragment newInstance(String param1, String param2) {
        settings_client_accp2_Fragment fragment = new settings_client_accp2_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_settings_client_accp2_, container, false);
