...
public class adapter_client_setting_accp3 extends FirebaseRecyclerAdapter<client_model_setting_accp3,adapter_client_setting_accp3.myviewholder> {

    public adapter_client_setting_accp3(@NonNull FirebaseRecyclerOptions<client_model_setting_accp3> options) {
        super(options);
    }
